...
runFlags = [];
runFlags.static = true;
runFlags.CSS    = false;
runFlags.boxL2  = false;
runFlags.DSS    = true;
...
N  = 256/4; % 256 % Image dimensions
nT = 256/4; % 256 % Number of frames,
dt = 0.01;        % Time step
...
params = getDefaultParameters(dTheta, 'rigidPhantom');
algoResults = struct();
...
if runFlags.DSS
    ...
    [V_DSS, en_DSS, t_DSS] = computeDynamicShapeSensingSolution(A, y(:), n, ...
        params.DSS.numIter, use_cuda, params.DSS.opt, V_static, params.DSS.plot_iterates);
...
save([resDir 'results.mat'], 'params', 'results', '-v7.3');
