function [V_frame, en_frame, t_frame] = computeCompressedShapeSensingSolution(A, y, ...
    n, nB, numIter, use_cuda, options)
%computeCompressedShapeSensingSolution generates a compressed shape sensing
%                   solution for binned dynamic reconstruction problem.
% 
...
fprintf('\n'); 
fprintf('=============================================================\n');
fprintf('<strong>                Compressed Shape Sensing</strong>\n');
fprintf('                     (Bin size: %d)\n', nB);
fprintf('=============================================================\n');
...
for i=1:nFrames
    ...
    % optimize here
    [xResult, en_frame(i)] = solveStaticCSSProblem(AI, currentY, [n(1) n(2)], numIter, use_cuda, options);
...
function [xResult, fIter] = solveStaticCSSProblem(AI, currentY, n, numIter, use_cuda, options)
...
for i=1:floor(numIter/xEstIter)
    ...
    % minimize
    [xIter, fIter] = minConf_SPG(fh, xIter, projectFunc, optimOpt);
